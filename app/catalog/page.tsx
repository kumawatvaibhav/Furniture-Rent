        ...
        <section className="py-12 sm:py-16 lg:py-20">
          <div className="container px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-3xl text-red-400 font-bold tracking-tight text-foreground sm:text-4xl">Explore Our Catalog</h2>
            ...
            <div className="mt-10 flex items-center justify-between">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  <DropdownMenuCheckboxItem>Living Room</DropdownMenuCheckboxItem>
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuCheckboxItem>Under $50/month</DropdownMenuCheckboxItem>
                  <DropdownMenuCheckboxItem>$50-$100/month</DropdownMenuCheckboxItem>
                  <DropdownMenuCheckboxItem>Over $100/month</DropdownMenuCheckboxItem>
                </DropdownMenuContent>
              </DropdownMenu>
            </div>
              ...
              <div className="group relative">
                ...
                <div className="mt-4 flex justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">$49/month</p>
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
              ...
              <div className="group relative">
                ...
                <div className="mt-4 flex justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">$39/month</p>
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
              ...
              <div className="group relative">
                ...
                <div className="mt-4 flex justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">$59/month</p>
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
              ...
              <div className="group relative">
                ...
                <div className="mt-4 flex justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">$69/month</p>
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
