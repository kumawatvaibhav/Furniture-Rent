...
const Header = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 flex px-8 py-3 justify-between z-10 backdrop-blur-lg transition-all">
      <Link href="/">
